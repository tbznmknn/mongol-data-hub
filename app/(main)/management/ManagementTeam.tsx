...
import { MailIcon, PhoneIcon, X, ArrowRight } from 'lucide-react';
...
export default async function ManagementTeam({ data }: { data: Member[] }) {
  return (
    <div className="mx-auto bg-blue-50 px-6 py-10">
