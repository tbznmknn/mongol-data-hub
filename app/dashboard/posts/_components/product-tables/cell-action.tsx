...
import { BookImage, Edit, Link2, MoreHorizontal, Trash } from 'lucide-react';
    ...
    <>
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => {
              const url = `${process.env.NEXT_PUBLIC_FRONTEND_URL}/posts/${data.id}`;
              navigator.clipboard
                .writeText(url)
                .then(() => {
                  toast.success('Клипборд руу линк хуулагдлаа');
                })
                .catch((error) => {
          ...
          >
            <Link2 className="mr-2 h-4 w-4" /> Хуулах
          </DropdownMenuItem>
          <DropdownMenuItem
