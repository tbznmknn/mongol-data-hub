    ...
    <PageContainer>
      <div className="space-y-4">
        <div className="flex items-start justify-between">
          <Heading
            title="Гишүүн компаниудын үйл ажиллагааны чиглэл"
            description="Бизнес чиглэл (бүртгэх, унших, засварлах, устгах)"
          />
          <Link
            href="/dashboard/occupation/new"
